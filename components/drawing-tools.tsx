...
import { MousePointer2, MousePointer, Hand, Link, Unlink, Plus, Hexagon, Image } from "lucide-react"

interface DrawingToolsProps {
  drawingMode: "nodes" | "pan" | "select" | "connect" | "disconnect" | "add-node" | "polygon" | "background"
  onDrawingModeChange: (mode: "nodes" | "pan" | "select" | "connect" | "disconnect" | "add-node" | "polygon" | "background") => void
}
  ...
  return (
    <div className="space-y-4">
      ...
      <div className="space-y-2">
        ...
        <div className="grid grid-cols-1 gap-1">
          <Toggle
            pressed={drawingMode === "background"}
            onPressedChange={() => onDrawingModeChange("background")}
